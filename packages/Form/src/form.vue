  ...
  <div class="container">
    ...
    <div class="main">
      <div class="left">
        <div class="field-group" v-for="(group, i) in componentsList" :key="i">
          ...
          <draggable
            ...
            :move="onMove"
            :clone="cloneElement"
            :group="{ name: 'form-group', pull: 'clone', put: false }"
          >
            <div
              class="list-item"
      ...
      <div class="center">
        ...
        >
          <div
            :class="`element-item ${element.isActive ? 'active' : ''}`"
      ...
      <div class="right">
        ...
        <div class="customize-attribute">属性</div>
      </div>
    </div>
  </div>
</template>
...
export default class AutoForm extends Vue {
  ...
  public selectComponent(e: elementItem, index: number) {
    ...
    if (this.elements[index].isActive) {
      this.activeEl = index;
    }
  }
  // 判断当前组件是否可以拖动
